...
#import "RNDatamiHTTPRequestHandler.h"
...
@interface RNDatamiHTTPRequestHandler () <NSURLSessionDataDelegate>

@end

@implementation RNDatamiHTTPRequestHandler
{
...
- (BOOL)canHandleRequest:(NSURLRequest *)request
{
  ...
  dispatch_once(&onceToken, ^{
    // technically, RNDatamiHTTPRequestHandler can handle file:// as well,
